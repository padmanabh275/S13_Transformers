...
class HuggingLitModule(LightningModule):
    def __init__(self,learning_rate: float,config: dict,tokenizer_src: Any,tokenizer_tgt: Any,) -> None:
        super().__init__()
    ...
    def forward(self,encoder_input: torch.Tensor,decoder_input: torch.Tensor,encoder_mask: torch.Tensor,decoder_mask: torch.Tensor,) -> torch.Tensor:
